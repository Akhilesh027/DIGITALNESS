...
const ContactInfoForm = () => {
    ...
    return (
        <>
            <Navbar />
            <section id="contact-info-form" className="relative overflow-hidden bg-[#edeafb] pt-36 pb-24 text-[#06053a]">
                ...
                <div className="relative mx-auto max-w-7xl px-4">
                    <div className="mx-auto mb-14 max-w-3xl text-center">
                        <span className="inline-flex rounded-full bg-white px-5 py-2 text-sm font-black uppercase tracking-[0.18em] shadow-lg">
                            Contact Digitalness
                        </span>
